<template>
    <AuthenticatedLayout>
        <div class="flex flex-col m-4">
            <h2 class="text-xl">BTQ</h2>
            <hr class="my-5 h-[2px] bg-gray-300" />
            <p>Pengajar: nama_guru</p>
            <p>Waktu: senin (08:00 - 08:30)</p>
            ...
            <div class="flex flex-row justify-around">
                <Link :href="route('module')" class="grid grid-cols-1 gap-3 place-items-center">
                    <img src="/icons/book-shelf.png" class="h-24 w-24" alt="">
                    <h3 class="text-md text-gray-500">Materi</h3>
                </Link>

                <Link :href="route('task')" class="grid grid-cols-1 gap-3 place-items-center">
